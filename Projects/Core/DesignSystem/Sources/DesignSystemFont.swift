...
public enum FontStyle: Equatable, Sendable {
    ...
    var fontConvertible: DesignSystemFontConvertible {
        ...
        case .heading1SemiBold, .heading2SemiBold, .body2SemiBold, .body3SemiBold, .caption1SemiBold, .caption2SemiBold, .caption3SemiBold:
            return DesignSystemFontFamily.Pretendard.semiBold
        case .heading3Medium, .heading4Medium, .body1Medium, .body2Medium, .body3Medium, .caption1Medium, .caption2Medium, .caption3Medium:
            return DesignSystemFontFamily.Pretendard.medium
        case .heading3Regular, .heading4Regular, .body1Regular, .body2Regular, .body3Regular, .caption1Regular, .caption2Regular, .caption3Regular:
...
extension View {
    ...
    func dsFont(_ style: FontStyle) -> some View {
        return self
            .font(.ds.font(style))
            .modifier(DSLineHeightModifier(fontSize: style.size, lineHeightMultiplier: 1.3, fontConvertible: style.fontConvertible))
    }
}
