...
- 🟦 **Checkbox** (COMPONENT_SET) `W: 60.0, H: 100.0` [Radius: 5]
  - 🖼️ **Variant: On** (COMPONENT) `W: 20.0, H: 20.0` [X: 20.0, Y: 20.0 | Fill: primary600 (primary600 (primary600 (#7f73ea))) (op: 1.00) | Radius: 6]
  ...
  - 🖼️ **Variant: Off** (COMPONENT) `W: 20.0, H: 20.0` [X: 20.0, Y: 60.0 | Fill: whiteOpacity60 (whiteOpacity60 (whiteOpacity60 (#ffffff))) (op: 1.00) | Stroke: gray300 (gray300 (gray300 (#dcdcdc))) (op: 1.00) | Radius: 6]
