...
- 🟦 **Header** (COMPONENT_SET) `W: 433.0, H: 208.0` [Fill: #f6f6f6 (op: 1.00) | Radius: 5]
  - 🖼️ **Variant: Header_sub** (COMPONENT) `W: 393.0, H: 48.0` [X: 20.0, Y: 127.0 | Fill: whiteOpacity60 (whiteOpacity60 (whiteOpacity60 (#ffffff))) (op: 1.00)]
    ...
    - 📝 **택일 운세** (TEXT) `W: 60.0, H: 24.0` [X: 167.0, Y: 13.5 | Font: dsBody2SemiBold | Color: black (black (black (#000000))) (op: 1.00)]
  ...
  - 🖼️ **Variant: Header_main** (COMPONENT) `W: 393.0, H: 60.0` [X: 20.0, Y: 39.0 | Fill: whiteOpacity60 (whiteOpacity60 (whiteOpacity60 (#ffffff))) (op: 1.00)]
    - 🟦 **Frame 1430106352** (FRAME) `W: 107.0, H: 30.0` [X: 20.0, Y: 15.0]
      - 📝 **Title** (TEXT) `W: 47.0, H: 30.0` [X: 0.0, Y: 0.0 | Font: dsHeading4Bold | Color: black (black (black (#000000))) (op: 1.00)]
      - 📝 **subtext** (TEXT) `W: 48.0, H: 20.0` [X: 59.0, Y: 5.0 | Font: dsBody3Regular | Color: gray500 (gray500 (gray500 (#9a9a9a))) (op: 1.00)]
    - 🖼️ **Iconex/Light/Bell** (INSTANCE) `W: 24.0, H: 24.0` [X: 349.0, Y: 18.0]
      - 🟦 **Bell** (GROUP) `W: 15.7, H: 20.0` [X: 4.0, Y: 2.0]
        - 🟦 **Union** (BOOLEAN_OPERATION) `W: 15.7, H: 16.5` [X: 0.0, Y: 0.0 | Stroke: gray975 (gray975 (gray975 (#171717))) (op: 1.00)]
