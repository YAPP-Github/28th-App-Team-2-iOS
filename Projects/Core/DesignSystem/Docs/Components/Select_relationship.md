...
- 🖼️ **Select relationship** (COMPONENT) `W: 353.0, H: 90.0`
  ...
  - 🟦 **Frame 1430105946** (FRAME) `W: 353.0, H: 48.0` [X: 0.0, Y: 42.0]
    - 🖼️ **SelectBox** (INSTANCE) `W: 109.7, H: 48.0` [X: 0.0, Y: 0.0 | Fill: whiteOpacity60 (#ffffff) (op: 1.00) | Stroke: coolGray300 (#d6dce5) (op: 1.00) | Radius: 12]
      - 📝 **연인** (TEXT) `W: 77.7, H: 21.0` [X: 16.0, Y: 13.5 | Font: dsBody1Medium | Color: coolGray800 (#373c46) (op: 1.00)]
    - 🖼️ **SelectBox** (INSTANCE) `W: 109.7, H: 48.0` [X: 121.7, Y: 0.0 | Fill: whiteOpacity60 (#ffffff) (op: 1.00) | Stroke: coolGray300 (#d6dce5) (op: 1.00) | Radius: 12]
      - 📝 **친구** (TEXT) `W: 77.7, H: 21.0` [X: 16.0, Y: 13.5 | Font: dsBody1Medium | Color: coolGray800 (#373c46) (op: 1.00)]
    - 🖼️ **SelectBox** (INSTANCE) `W: 109.7, H: 48.0` [X: 243.3, Y: 0.0 | Fill: whiteOpacity60 (#ffffff) (op: 1.00) | Stroke: coolGray300 (#d6dce5) (op: 1.00) | Radius: 12]
