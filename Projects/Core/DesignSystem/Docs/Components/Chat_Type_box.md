...
- 🟦 **Chat Type box** (COMPONENT_SET) `W: 1194.0, H: 188.0` [Radius: 5]
  ...
  - 🖼️ **Variant: Filled** (COMPONENT) `W: 353.0, H: 64.0` [X: 20.0, Y: 104.0 | Fill: white (#ffffff) (op: 1.00) | Stroke: gray50 (#f5f5f5) (op: 1.00) | Radius: 24]
    ...
    - 🟦 **Group 1171275303** (GROUP) `W: 32.0, H: 32.0` [X: 301.0, Y: 16.0]
      ...
      - 🖼️ **arrow_upward** (INSTANCE) `W: 24.0, H: 24.0` [X: 4.0, Y: 4.0]
  - 🖼️ **Variant: Variant3** (COMPONENT) `W: 353.0, H: 104.0` [X: 398.0, Y: 19.0 | Fill: white (#ffffff) (op: 1.00) | Stroke: gray50 (#f5f5f5) (op: 1.00) | Radius: 24]
    ...
    - 🟦 **Group 1171275303** (GROUP) `W: 32.0, H: 32.0` [X: 301.0, Y: 56.0]
      - 🟦 **Ellipse 57** (ELLIPSE) `W: 32.0, H: 32.0` [X: 0.0, Y: 0.0 | Fill: primary600 (#7f73ea) (op: 1.00)]
      - 🖼️ **arrow_upward** (INSTANCE) `W: 24.0, H: 24.0` [X: 4.0, Y: 4.0]
  - 🖼️ **Variant: Variant4** (COMPONENT) `W: 353.0, H: 104.0` [X: 767.0, Y: 19.0 | Fill: white (#ffffff) (op: 1.00) | Stroke: gray50 (#f5f5f5) (op: 1.00) | Radius: 24]
